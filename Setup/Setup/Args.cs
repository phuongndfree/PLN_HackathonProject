...
namespace CRFSharpWrapper
{
    public class EncoderArgs
    {
        ...
        public double min_diff = 0.001; //minimum diff value, when diff less than the value consecutive 3 times, the process will be ended.
        public double slot_usage_rate_threshold = 0.95; //the maximum slot usage rate threshold when building feature set.
        public int threads_num = 14; //the amount of threads used to train model.
